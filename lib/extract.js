const XP  = require('expandjs'),
    ...
    zstdBinPath = path.resolve(__dirname, '..', 'node_modules', 'node-zstandard', 'bin', zstdBin);
...
const _ensureFile = (header, file, next) => {
    switch (header.type) {
        ...
        case 0x02:
            console.log('File redirection. Please file an issue at https://github.com/Pupix/lol-wad-parser/issues if you see this');
            next();
            break;
